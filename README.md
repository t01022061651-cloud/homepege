...
- **진한 파스텔톤 디자인**: 깊이 있고 세련된 색상 구성
- **AOS 애니메이션**: 스크롤 시 부드러운 애니메이션 효과
- **Skills 섹션**: 데이터 분석과 소프트웨어 역량을 시각적으로 표현
...
```css
:root {
    --primary-color: #9B86D6;  /* 메인 색상 - 진한 라벤더 */
    --secondary-color: #FF96A0; /* 보조 색상 - 진한 로즈 */
    --accent-color: #7EC4A0;   /* 강조 색상 - 진한 민트 */
}
```
